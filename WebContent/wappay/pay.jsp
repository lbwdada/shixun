...
if(request.getParameter("WIDout_trade_no")!=null){
   ...
   String timeout_express="2m";
    ...
    // 设置异步通知地址
    alipay_request.setNotifyUrl("http://localhost:8080/shixun_demo/orders?method=updateOrders&order_number="+out_trade_no);
    // 设置同步地址
    alipay_request.setReturnUrl("http://localhost:8080/shixun_demo/orders?method=updateOrders&order_number="+out_trade_no);   
