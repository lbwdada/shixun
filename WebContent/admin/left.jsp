...
<body style="background:#f0f9fd;">
    ...
    <dd>
    <div class="title">
    <span><img src="images/leftico01.png" /></span>小镇功能
    </div>
    	<ul class="menuson">
        ...
        <li><cite></cite><a href="${pageContext.request.contextPath }/category?method=findAllByPage&currentPage=1&pageSize=3" target="rightFrame">商品类别管理</a><i></i></li>
        <li><cite></cite><a href="${pageContext.request.contextPath }/commodity?method=findSelectByPage&currentPage=1&pageSize=3" target="rightFrame">商品管理</a><i></i></li>
