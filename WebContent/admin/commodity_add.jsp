...
<body>
    ...
    <form action="commodity?method=addCommodity" method="post" enctype="multipart/form-data">
	    ...
	    <ul class="forminfo">
		    ...
		    <li><label>商品小类别</label>
			    <cite>
				    ...
				    <input name="state" type="radio" value="2" />新品
				    <input name="state" type="radio" value="3" />为你推荐
				    <input name="state" type="radio" value="4" />明星单品
			    </cite>
		    </li>
