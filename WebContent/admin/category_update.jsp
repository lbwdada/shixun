...
<body>
    ...
    <form action="${pageContext.request.contextPath }/category?method=updateCategory" method="post">
	    ...
	    <ul class="forminfo">
		    ...
		    <li><label>是否启用</label>
			    <cite>
				    <input name="state" type="radio" value="1" <c:if test="${category.state==1 }">checked</c:if>></input>是&nbsp;&nbsp;&nbsp;&nbsp;
				    	
				    <input name="state" type="radio" value="0" <c:if test="${category.state==0 }">checked</c:if> >否</input>
			    </cite>
		    </li>
