 ...
 <jsp:include page="header.jsp"></jsp:include>
   ...
   <div class="plus5_no3">
        <div class="plus5_no3_img">
            <img width="560px" height="560px" src="http://localhost:8080/picture/${commodity.pic }" style="display: block" alt="">
        </div>
        <div class="plus5_no3_right">
            ...
            <div style="margin-bottom: 20px">
        		   购买数量:<input type="text" name="count" value="1" onblur="fun1(this.value)">
            </div>
            ...
            <script type="text/javascript">
            	...
            	function addCart(){
            		...
            		location.href="cart?method=addCart&cid="+cid+"&count="+count;
            ...
            <div class="plus5_no3_right_div10">
                ...
                <p class="plus5_no3_right_div10_p2" style="font-size: 18px;font-weight: bold;" id="p1">总计 ：${commodity.price } 元</p>
